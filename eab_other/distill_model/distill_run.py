...
from index_eab.eab_other.distill_model.distill_utils.distill_loss import QError, RatioLoss, cal_mape
...
def cost_train(model, train_loader, valid_loader, args):
    ...
    for epoch in tqdm(range(1, args.epoch + 1)):
        ...
        for bi, batch in pro_bar:
            ...
            distill_com.add_summary_value("train loss", loss.item())
            distill_com.tf_step += 1
            if distill_com.tf_step % 100 == 0:
                distill_com.summary_writer.flush()
        ...
        for bi, batch in pro_bar:
            ...
            distill_com.add_summary_value("train valid loss", loss.item())
            distill_com.tf_step += 1
            if distill_com.tf_step % 100 == 0:
                distill_com.summary_writer.flush()
