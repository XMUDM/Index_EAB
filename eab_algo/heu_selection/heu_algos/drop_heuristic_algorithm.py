...
from index_eab.eab_algo.heu_selection.heu_utils.selec_com import mb_to_b, b_to_mb, get_utilized_indexes
from index_eab.eab_algo.heu_selection.heu_utils.candidate_generation import candidates_per_query, \
        ...
        while True:
            ...
            for no, index in enumerate(remaining_indexes):
                ...
                if self.sel_oracle == "cost_per_sto":
                    ...
                    storage = 0
                    for ind in remaining_indexes - set([index]):
                        storage += ind.estimated_size
                    cost = cost * b_to_mb(storage)
