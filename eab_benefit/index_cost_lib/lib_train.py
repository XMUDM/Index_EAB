...
from index_eab.eab_benefit.index_cost_lib.utils import lib_com
from index_eab.eab_benefit.index_cost_lib.lib_data import collate_fn4lib
from index_eab.eab_benefit.index_cost_lib.lib_model import make_model, self_attn_model, q_error
...
def get_parser():
    ...
    parser.add_argument("--model_path", type=str, default="./model/LIB_query.pth",
