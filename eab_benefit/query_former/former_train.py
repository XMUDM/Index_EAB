...
from index_eab.eab_benefit.query_former.model.trainer import eval_workload, train
...
def get_parser():
    ...
    parser.add_argument("--train_data_file", type=str,
                        default="/data/wz/index/index_eab/eab_benefit/cost_data/tpch/tpch_cost_data_tgt_train.json")
    parser.add_argument("--valid_data_file", type=str,
                        default="/data/wz/index/index_eab/eab_benefit/cost_data/tpch/tpch_cost_data_tgt_valid.json")

    parser.add_argument("--encoding_load", type=str,
                        default="data/tpch/encoding_tpch.pt")
    parser.add_argument("--model_load", type=str,
                        default="checkpoints/cost_model.pt")
