...
def print_qerror(preds_unnorm, labels_unnorm, prints=False):
    ...
    if prints:
        logging.info("Mean: {}, Median: {}, 90th: {}".format(e_mean, e_50, e_90))
...
def train(model, train_ds, val_ds, crit, cost_norm, args,
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if epoch > 40:
            test_scores, corrs = evaluate(model, val_ds, bs, cost_norm, device, prints=False)
