...
from index_eab.eab_benefit.optimizer_cost.optimizer_utils import optimizer_com
from index_eab.eab_benefit.optimizer_cost.optimizer_utils.optimizer_loss import cal_mape, QError
from index_eab.eab_benefit.optimizer_cost.optimizer_model import Optimizer
...
for bench in ["job"]:  # "tpch", "tpcds", "job"
    # args.train_data_load = f"/data/wz/index/index_eab/eab_benefit/cost_data/{bench}/{bench}_cost_data_tgt_train.json"
    args.train_data_load = f"/data/wz/index/index_eab/eab_benefit/optimizer_cost/data/{bench}/openGauss_{bench}_cost_data_tgt_train.json"
    ...
    args.test_data_load = f"/data/wz/index/index_eab/eab_benefit/optimizer_cost/data/{bench}/openGauss_{bench}_cost_data_tgt_test.json"
