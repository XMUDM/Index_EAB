...
def get_heu_multi_query_res():
    ...
    # qnos = list(range(1, 33 + 1))

    args.work_file = "/data/wz/index/index_eab/eab_olap/bench_temp/job/job_query_temp_multi_n113.json"
    args.res_save = "/data/wz/index/index_eab/eab_olap/bench_result/job/query_level/job_template_33_multi_query_index.json"
...
def get_swirl_multi_query_res():
    ...
    for agent in ["dqn"]:
        ...
        args.res_save = f"/data/wz/index/index_eab/eab_olap/bench_result/job/query_level/" \
                        f"job_template_33_multi_query_index_{agent}.json"
        if args.res_save is not None:
            if not os.path.exists(os.path.dirname(args.res_save)):
                os.makedirs(os.path.dirname(args.res_save))
            with open(args.res_save, "w") as wf:
...
def get_mcts_multi_query_res():
    ...
    args.work_file = "/data/wz/index/index_eab/eab_olap/bench_temp/job/job_query_temp_multi_n113.json"
    args.res_save = f"/data/wz/index/index_eab/eab_olap/bench_result/job/query_level/" \
                    f"job_template_33_multi_query_index_mcts.json"
...
def get_mab_multi_query_res():
    ...
    args.work_file = "/data/wz/index/index_eab/eab_olap/bench_temp/job/job_query_temp_multi_n113.json"
    args.res_save = f"/data/wz/index/index_eab/eab_olap/bench_result/job/query_level/" \
                    f"job_template_33_multi_query_index_mab.json"
...
def remove_step_info():
    res_dir = "/data/wz/index/index_eab/eab_olap/bench_result/job/query_level"
