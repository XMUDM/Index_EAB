...
def merge_query_result(data_id):
    sel_load = "/data/wz/index/index_eab/eab_olap/bench_result/tpch/query_level/tpch_1gb_template_22_multi_query_index_simple.json"
    ...
    for algo in ["drop"]:
        sel_load = f"/data/wz/index/index_eab/eab_olap/bench_result/tpch/query_level/tpch_1gb_template_22_multi_query_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
def merge_work_result(data_id):
    ...
    sel_loads = [
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index0-20_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index20-40_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index40-60_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index60-80_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index80-100_simple.json"]
    ...
    sel_loads = [
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_drop0-20_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_drop20-40_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_drop40-60_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_drop60-80_simple.json",
        "/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_drop80-100_simple.json"]
    ...
    for algo in list(rl_agents.keys()):
        sel_load = f"/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/tpch_1gb_template_18_multi_work_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
def ebar_query_plot(data_id, save_path=None, save_conf={"format": "pdf", "bbox_inches": "tight"}):
    ...
    # colors = ["#2A4458", "#3E86B5", "#E5BE79", "#B783AF", "#ABC9C8", "#A4757D",
    #           "#336485", "#95A77E", "#736B9D", "#F5A673", "#E7E5DF"]
...
if __name__ == "__main__":
    ...
    for data_id in ["index_utility", "time_duration"]:
        save_path = f"/data/wz/index/index_eab/eab_olap/bench_result/tpch/query_level/" \
                    f"tpch_1gb_multi_query_bench_{data_id.replace(' ', '_')}_ebar.pdf"
        ebar_query_plot(data_id, save_path=save_path)

    save_path = None
    for data_id in ["index_utility", "time_duration"]:
        save_path = f"/data/wz/index/index_eab/eab_olap/bench_result/tpch/work_level/" \
                    f"tpch_1gb_multi_work_bench_{data_id.replace(' ', '_')}_ebar.pdf"
