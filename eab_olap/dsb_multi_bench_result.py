...
def merge_query_result(data_id):
    ...
    sel_load = "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/query_level/dsb_1gb_template_53_multi_query_index_simple.json"
    ...
    sel_load = "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/query_level/dsb_1gb_template_53_multi_query_index_drop_simple.json"
    with open(sel_load, "r") as rf:
        sel_data = json.load(rf)
    ...
    for algo in list(rl_agents.keys()):
        sel_load = f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/query_level/dsb_1gb_template_53_multi_query_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
def merge_work_result(data_id):
    ...
    sel_loads = [
        "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index0-20_simple.json",
        "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index20-40_simple.json",
        "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index40-60_simple.json",
        "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index60-80_simple.json",
        "/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index80-100_simple.json"]
    for algo in heu_algos:
    ...
    for algo in ["relaxation", "drop"]:
        sel_loads = [
            f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}0-20_simple.json",
            f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}20-40_simple.json",
            f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}40-60_simple.json",
            f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}60-80_simple.json",
            f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}80-100_simple.json"]
    ...
    for algo in list(rl_agents.keys()):
        sel_load = f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/dsb_1gb_template_53_multi_work_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
def ebar_query_plot(data_id, save_path=None, save_conf={"format": "pdf", "bbox_inches": "tight"}):
    ...
    for rid in range(int(np.ceil(temp_num / row_qnum))):
        ...
        groups = [f"Q{qno}" for qno in range(1, temp_num + 1)][rid * row_qnum:(rid + 1) * row_qnum]
        ...
        for algo in data["1"].keys():
            query_data = [np.mean(data[str(qno)][algo]) for qno in range(1, temp_num + 1)][
                         rid * row_qnum:(rid + 1) * row_qnum]
            yerr_data = [np.std(data[str(qno)][algo]) for qno in range(1, temp_num + 1)][
                        rid * row_qnum:(rid + 1) * row_qnum]
...
if __name__ == "__main__":
    ...
    #     save_path = f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/query_level/" \
    #                 f"dsb_1gb_multi_query_bench_{data_id.replace(' ', '_')}_ebar.pdf"
    #     ebar_query_plot(data_id, save_path=save_path)

    save_path = None
    for data_id in ["index_utility", "time_duration"]:
        save_path = f"/data1/wz/index/index_eab/eab_olap/bench_result/dsb/work_level/" \
                    f"dsb_1gb_multi_work_bench_{data_id.replace(' ', '_')}_ebar.pdf"
