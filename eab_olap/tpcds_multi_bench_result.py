# -*- coding: utf-8 -*-
# @Project: index_test
# @Module: tpcds_multi_bench_result
# @Author: Wei Zhou
...
def merge_query_result(data_id):
    ...
    sel_loads = [
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/query_level/tpcds_1gb_template_99_multi_query_index_0-2200_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/query_level/tpcds_1gb_template_99_multi_query_index_2200-4400_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/query_level/tpcds_1gb_template_99_multi_query_index_4400-6600_simple.json"]
    ...
    for sel_load in sel_loads:
        ...
        for qno in sel_data.keys():
            ...
            for algo in heu_algos:
                ...
                if algo not in result[qno].keys():
                    result[qno][algo] = list()

                result[qno][algo].extend(get_res_data(sel_data[qno], algo, data_id))

    for algo in list(rl_agents.keys()):
        sel_load = f"/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/query_level/tpcds_1gb_template_99_multi_query_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
def merge_work_result(data_id):
    ...
    sel_loads = [
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index0-20_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index20-40_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index40-60_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index60-80_simple.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index80-100_simple.json"]

    for algo in heu_algos:
        # if algo in ["drop", "relaxation"]:
        if algo in ["relaxation"]:
            continue
    ...
    sel_loads = [
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_relaxation0-20.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_relaxation20-40.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_relaxation40-60.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_relaxation60-80.json",
        "/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_relaxation80-100.json"]

    # result["relaxation"] = list()
    # for sel_load in sel_loads:
    #     with open(sel_load, "r") as rf:
    #         sel_data = json.load(rf)
    #
    #     result["relaxation"].extend(get_res_data(sel_data, algo, data_id))

    for algo in list(rl_agents.keys()):
        sel_load = f"/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/tpcds_1gb_template_83_multi_work_index_{algo}_simple.json"
        with open(sel_load, "r") as rf:
            sel_data = json.load(rf)
...
if __name__ == "__main__":
    ...
    for data_id in ["index_utility", "time_duration"]:
        save_path = f"/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/query_level/" \
                    f"tpcds_1gb_multi_query_bench_{data_id.replace(' ', '_')}_ebar.pdf"
        ebar_query_plot(data_id, save_path=save_path)

    save_path = None
    for data_id in ["index_utility", "time_duration"]:
        save_path = f"/data2/wz/index/index_eab/eab_olap/bench_result/tpcds/work_level/" \
                    f"tpcds_1gb_multi_work_bench_{data_id.replace(' ', '_')}_ebar.pdf"
